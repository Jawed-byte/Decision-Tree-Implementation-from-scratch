# -*- coding: utf-8 -*-
"""2023201051_A1_Q1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1OGI0snQUSHc03OB9JJSVTLIgjglJ6K7g
...
class DecisionTree:
    ...
    def plot_accuracy_vs_depth(self, X_train, y_train, X_test, y_test):
...
clf = DecisionTree(max_depth=15)
acc_dt=clf.plot_accuracy_vs_depth(X_train, y_train, X_test, y_test)
